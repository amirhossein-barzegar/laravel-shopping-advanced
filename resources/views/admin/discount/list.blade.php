            ...
            <div class="flex flex-col justify-between items-center gap-2 px-4 py-3 sm:flex-row">
                <div class="text-lg text-center sm:text-right font-semibold text-gray-800 bg-white">
                    ...
                    <p class="mt-1 text-sm font-normal text-gray-500">
                        نمای کلی از تمام تخفیف ها مشاهده کنید.
                    </p>
                </div>
                <a href="{{ route('discount.create') }}" class="flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 transition-colors duration-150 text-white text-xs px-4 py-2 rounded-lg">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white {{$loop->last ? '': 'border-b'}}">
                            ...
                            <td class="px-6 py-4 text-right flex gap-2 justify-center">
                                <a href="{{ route('discount.edit',$discount->id) }}" class="font-medium bg-yellow-500 w-6 h-6 grid place-items-center rounded shadow-sm hover:bg-yellow-600 transition-colors duration-150 text-white">
