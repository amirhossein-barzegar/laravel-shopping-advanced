                ...
                <li class="flex gap-4 text-sm items-center">
                    ...
                    <ul>
                        <li class="flex gap-4 text-sm items-center">
                            ...
                            <ul>
                                <li>
                                    <div class="text-gray-400 text-sm">ویرایش دسته بندی</div>
                                </li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div class="col-start-4 col-span-6 bg-white px-4 py-3 border border-gray-100 rounded">
            <div class="flex flex-col justify-between items-center gap-2 px-4 py-3 sm:flex-row">
                <div class="text-lg text-center sm:text-right font-semibold text-gray-800 bg-white">
                    ...
                    دسته بندی مورد نظر خود را در اینجا ویرایش کنید
                    </p>
                </div>
            </div>
            <form action="{{ route('post-category.update', $postCategory->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="flex flex-col gap-1 mt-2">
                    <button class="flex items-center justify-center text-sm gap-2 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 outline-none rounded-lg focus:ring-2 focus:ring-blue-300 focus:border-gray-200 transition-all duration-200">ویرایش دسته بندی</button>
                </div>
            </form>
        </div>
    </div>
